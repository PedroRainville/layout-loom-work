...
export default function MyConnections() {
  ...
  const connections = [
    ...
    {
      name: "Cesar Augusto",
      creci: "CRECI 56854 - SP",
      hasCommonConnections: false,
    },
  ];
      ...
      <div className="p-6 max-w-md mx-auto">
        <div className="text-center mb-4">
          <p className="text-sm text-foreground">
            O parceiro <strong>Bruno Pereira Aceitos</strong> seu Convite
          </p>
        </div>

        <div className="flex items-center gap-2 mb-6">
          <Logo size="sm" />
          <h1 className="text-xl font-semibold text-foreground">Minhas Conexões</h1>
        </div>
            ...
            <div key={index} className="border border-border rounded-lg p-4">
              <div className="flex items-start gap-3 mb-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground">{connection.creci}</p>
                  {connection.hasCommonConnections && (
